(function () {
  ...
  var CONSULTORIAS = [
    { label: 'Diagnóstico do Sono', href: 'Diagnostico.dc.html', desc: 'Por onde começar · R$ 399,99' },
    ...
    { label: 'Consultoria Individual ★', href: 'Consultoria Individual.dc.html', desc: 'A mais escolhida · R$ 1.100', hl: true },
